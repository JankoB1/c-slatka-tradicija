        ...
        @if($recipe->old_recipe == 0)
            <div class="swiper single-recipe-gallery">
                <div class="swiper-wrapper">
                    @if($recipe->yt_video != null)
                        <div class="swiper-slide">
                            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/{{ $recipe->yt_video }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </div>
                    @endif
                    @if(count($recipe->images) > 0)
