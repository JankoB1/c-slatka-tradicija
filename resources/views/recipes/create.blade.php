                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <select name="category">
                                        ...
                                        <option value="Kategorija 1 hardcoded">Kategorija 1 hardcoded</option>
                                        <option value="Kategorija 2 hardcoded">Kategorija 2 hardcoded</option>
                                        <option value="Kategorija 3 hardcoded">Kategorija 3 hardcoded</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
