...
@section('content')
    <section id="create-recipe-hero" class="contact-hero impressum-hero">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="contact-blurb">
                        ...
                        <p><a href="tel:%20+38122800300">+381 (0)22 800 300</a><br><a href="tel:%20+38122800300">+381 (0)22 800 300</a></p>
                    </div>
                    <div class="contact-blurb">
                        <img src="{{ asset('images/contact-4.svg') }}" alt="contact">
                        <p>Matični broj: 17328573<br>Privredni sud Beograd</p>
                    </div>
                </div>
                <div class="col-md-6">
